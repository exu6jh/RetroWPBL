...
2. Pitch blocking info ("*" in pitch sequences) is not present since I do not have a clear idea of what constitutes the standard for a blocked pitch in Retrosheet, and any information I could include would not particularly informative.
### Biodata notes:
